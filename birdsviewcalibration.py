...
def draw_ref_points(image):
    ...
    # Top left
    cv2.circle(image, (908, 745), 6, (0, 0, 255), -1)
    # Bottom left
    cv2.circle(image, (400, image.shape[0]), 6, (0, 0, 255), -1)
    # Bottom right
    cv2.circle(image, (1515, image.shape[0]), 6, (0, 0, 255), -1)
    # Top right
    cv2.circle(image, (1000, 745), 6, (0, 0, 255), -1)
    return image
...
if __name__ == '__main__':
    ...
    cv2.imwrite('output_image/points_image.png', points_image)
    plt.figure()
    plt.imshow(birdsview_image)
    plt.figure()
    cv2.imwrite('output_image/birdsview_image.png', birdsview_image)
    plt.show()
